...
const char u1_uid[] PROGMEM = "570064A276"; 
const char u1_name[] PROGMEM = "Ex-Student";   
...
const char u4_uid[] PROGMEM = "570067BA4D"; const char u4_name[] PROGMEM = "Aditi";       
 const char u4_role[] PROGMEM = "S"; const char u4_pass[] PROGMEM = "D9877";

const char u5_uid[] PROGMEM = "5700657DA1"; const char u5_name[] PROGMEM = "Anushka";      
const char u5_role[] PROGMEM = "S"; const char u5_pass[] PROGMEM = "D8709";
...
User* UserDB::findUser(const char* scannedUid) {
    ...
    for(int i = 0; i < 5; i++) {
        ...
        if(strcasecmp(scannedUid, flashUidBuf) == 0) {
            ...
            tempUser = User(flashUidBuf, t_name, t_role, t_pass, true); 
